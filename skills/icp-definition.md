# skills/icp-definition.md — Deal ICP Definition (Solstice Health Ventures, fictional)

> The "Supernova" is the fund's internal term for the ideal deal.
> This definition is reviewed after every IC. See evolution history at the end.

---

## The "Supernova" — Tier 1 Deal (enter process immediately)

Meets ALL of these criteria:

**Return potential**
- Seed: potential >10x in 5-6 years
- Series A: potential 5-10x in 3-4 years
- Must have a validated "exit point" with potential buyers in <2-4 years

**Equity and valuation**
- Equity >5% for the fund in the deal
- Or post-money <€20M

**Ticket**
- First ticket: €750K
- Follow-on capacity up to €4-5M total per company

**Sector**
- Digital Health broadly defined
...
- Demonstrable sales: signed contracts, LOIs, paid pilots, or growing ARR
- Relevant partnerships with healthcare ecosystem players

**Team**
- Top team — ideally with prior joint experience
- Bonus: prior exit or direct background in the healthcare sector
- Commercial + technical balance in the founding team
...
**Operating flow**
- Call with founder → if it fits, request the data room
- If the data room confirms the fit → present at the weekly meeting (Review)
- If it doesn't fit at the call or data room stage → move to Pass directly

---

## Tier 2 — Partial fit, right timing (Watch Soon)

Meets the sector, geography, and team criteria, but is missing one of the following:
traction still early, quality co-investors not yet confirmed, valuation somewhat
stretched but negotiable, or return potential somewhat below target but with clear
strategic upside.

**Decay:** re-contact in <6 months from the last interaction.

**CRM stage:** Watch soon

---

## Tier 3 — Potential but premature timing (Watch for Later)

Interesting companies that aren't yet at the right timing for the fund. Mostly
pre-seed companies raising their first round, with minimal traction but a clear
thesis and a promising team.

**Decay:** re-contact in 6-12 months from the last interaction. No signal in 12
months → automatic Move to Pass.

**CRM stage:** Watch later

---

## Tier 4 / Anti-ICP — Discard directly (Move to Pass)

- ❌ Pre-product with no traction and no real market signal
- ❌ Team with no relevant background in healthcare OR technology
- ❌ Pure B2C in healthcare with no institutional distribution channel
- ❌ Valuation that leaves equity <5% with our ticket and no room to negotiate
...
- A reference co-investor brings the opportunity
- Public announcement of a round, institutional partnership, or relevant contract
- Significant change in the founding team
...
## Quick qualification framework (5 IC questions)
